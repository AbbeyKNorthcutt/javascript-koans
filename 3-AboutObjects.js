describe("3. About Objects", () => {
  ...
  it("should know that properties can be added and deleted", () => {
    ...
    expect(megalomaniac["secretary"]).toBe(false);

    megalomaniac.secretary = "Agent Smith";
    expect(megalomaniac["secretary"]).toBe(true);

    delete megalomaniac.henchman;
    expect(megalomaniac["henchman"]).toBe(false);
  });
  ...
  it("should create your own simple object", () => {
    var myNewObject = new catPajamas();
    myNewObject.prop1 = "a property!";
    myNewObject.prop2 = [4,3,2];
    myNewObject.prop3 = "a property that is a method!";
